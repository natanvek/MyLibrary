...
/*----------------------------------------------------------------*
    description: hace lo mismo que howManyInRange pero mas eficiente y tiene algunas funciones extra que pintan copadas, lo que si solo sirve para valores positivos aunque se puede shiftear todo afuera para usarla con negativos pero es medio paja 
*----------------------------------------------------------------*/
...
// 3) find the k-th smallest / k-th largest v[i] for i in [start, end)
