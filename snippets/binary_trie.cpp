...
/*----------------------------------------------------------------*
    description: binary_trie sacado de la libreria de maspy con varias funciones agregadas muy copadas
*----------------------------------------------------------------*/
...
//// --- new tree ---
// Binary_Trie<bits, false, 2.5 * nodos> BT; 

//// --- add root --- 
// auto root = BT.new_root();

//// --- add element --- 
// root = BT.add(root, x, /*cantidad deseada defecto = 1*/);
