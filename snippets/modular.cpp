...
/*----------------------------------------------------------------*
    description: varias funciones utiles para simplificar la sintaxis de la aritmetica modular 
*----------------------------------------------------------------*/
...
void compute_factorial(int n) {
    fact.resize(n+10, 1);
    forn(i, 1, n+1) fact[i] = fact[i-1] * i;
}
// agregar compute_factorial(n); al main() 